...
import TeamCollaboration from '../assets/images/marketing_team-collaboration.jpg';
...
import CrmWebFormsImage from '../assets/images/marketing-crm-web-forms.jpg';
import marketingBenefitsImage from '../assets/images/marketing_benefits.jpg.webp';
      ...
      type: [
        {
          ...
          features: {
            ...
            content: [
              ...
              {
                title: "CRM web forms",
                icon: <WebFormsIcon width={35} height={35} />,
                image: CrmWebFormsImage,
