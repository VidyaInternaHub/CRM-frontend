...
import SelfEnterpriseImage from "../../assets/images/SelfEindex-box_3.900w.jpg";

const features = [
  {
    title: "Top speed and performance",
    description:
      "No matter how many processes you launch or how many requests you make, the self-hosted version Bitrix24 will be more than capable of handling them.",
  },
  {
    title: "Highly reliable and universally accessible",
    description:
      "Whether you employ a few dozen people in the same office, or a few thousand people across multiple continents, Bitrix24 will always ensure stable performance and universally quick access to the system.",
  },
  {
    title: "Easily scalable",
    description:
      "With the Bitrix24 on-premise edition, you can easily scale up from a small trial to a company-wide implementation and deploy independent intranets for each branch, department, or subsidiary in your company.",
  },
];

const SelfEnterprise = () => {
  return (
    <section className="bg-white">
      ...
      <div className="p-20 text-center">
        ...
        Working with large amounts of data, processes, or requests? Need a scalable software solution for your company? Go with Bitrix24 on-premise.
        </p>
      </div>
      ...
      <div className="md:w-1/2 flex justify-center">
          <img src={SelfEnterpriseImage} alt="Self Hosted Bitrix24" className="max-w-full md:max-w-lg" />
        </div>
        ...
        <div className=" max-w-[1114px] w-full  flex flex-col lg:flex-row items-center justify-between px-5 p-4 ">
          <div>
            ...
            <div >
              ...
              <p > LDAP and Active Directory support</p> 
            </div>
