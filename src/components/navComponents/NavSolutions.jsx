...
const NavSolutions = () => {
    ...
    const tabs = [
        ...
        },
        {
            ...
            content: ["Telephony", "CRM", "Calander", "Contact center", "Tasks & projects", "Website builder"]
        },
        {
            id: 5,
            label: "BUSINESS SIZE",
            ...
            content: ["Solo enterprenurs", "Small buisness", "Enterprise"]
        },
    ]
                                ...
                                <div>
                                    <ul className='flex flex-col gap-y-4 justify-center items-start'>
                                        {tab.content.map((item, index) => (
                                            <li key={index} className='hover:text-blue-mainml-5 text-font-sm'><a href="">{item}</a></li>
                                        ))}
                                    </ul>
                                </div>
                            </div>
