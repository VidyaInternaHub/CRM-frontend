...
const HeroSection = () => {
  return (
    <div className=" flex flex-col w-full bg-hero-image bg-center bg-no-repeat">
      ...
      {/* footer */}
      <div className=" h-28 bg-blue flex justify-center items-center w-full">
        <div className=" max-w-[1114px] w-full text-white text-xl font-medium lg:text-xl flex flex-col lg:flex-row items-center justify-between px-5">
          <div className="flex items-center gap-2 ">
            <div className="hidden lg:flex border-2 border-white border-opacity-40 lg:bg-white lg:bg-opacity-40 rounded-full w-fit lg:px-16 justify-center items-center lg:text-2xl ">
